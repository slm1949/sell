...
$this->menu=array(
	array('label'=>Yii::t('admin', 'Create {model}', array('{model}'=>Yii::t('model', 'News'))),'url'=>array('create')),
);
...
<h1><?php echo Yii::t('admin', 'Manage {model}', array('{model}'=>Yii::t('model', 'News'))); ?></h1>
